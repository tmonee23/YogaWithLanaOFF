...
export default function Navbar() {
    ...
    const tabs = ["Home", "Benefits", "Testimonials", "Coaching", "Leela-Game", "Reiki", "Meditation", "Gallery", "Nutrition" ,"About Me"]
    ...
    return (
        <div>
            ...
            <nav ref={el => navbarContainer = el} className="navbar-container">
                ...
                <div className="navbar-youtubeLinkBreak"></div>
                <li className="navbar-list-item">
                    <a className="navbar-link navbar-youtubeLink" target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/channel/UCLe1roVf_eiz3FJo5WDR0xQ">My Youtube Page</a>
                </li>
            </nav>
        </div>
    )
