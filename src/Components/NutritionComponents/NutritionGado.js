...
export default function NutritionGado() {
    ...
    return (
        <div className="page-container">
            <div ref={el => pageContainer = el}  className="recipe-container">
                ...
                <img alt="gado-gado-recipe" src="https://momswebsitereal.s3.eu-central-1.amazonaws.com/Nutrition/11.jpg" className="recipe-picture"></img>
